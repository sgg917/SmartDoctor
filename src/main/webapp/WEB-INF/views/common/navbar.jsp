...
<body>
	...
	<nav
		...
		<div
			...
			<a class="navbar-brand brand-logo goodeelogo" href="index.jsp"><img
				src="resources/images/twitter_header_photo_1.png" alt="logo"
				style="width: 250px; height: 57px;" /></a> <a
				class="navbar-brand brand-logo-mini" href="index.jsp"><img
				src="resources/images/favicon2.jpg" alt="logo" /></a>
		</div>
		<div class="navbar-menu-wrapper d-flex align-items-stretch">
			...
			<ul class="navbar-nav navbar-nav-right">
				...
				<li class="nav-item d-none d-lg-block full-screen-link"><a
					class="nav-link"> <i class="mdi mdi-comment-processing-outline"
						id="fullscreen-button"></i>
				</a></li>
			...
			<ul class="nav">
				<li class="nav-item nav-profile"><a href="#" class="nav-link">
						<div class="nav-profile-image">
							<img src="resources/profile_images/eunwoo.jpg" alt="profile">
							<!--사용자 프로필사진-->
							<span class="login-status online"></span>
							<!--change to offline or busy as needed-->
						</div>
						<div class="nav-profile-text d-flex flex-column">
							<span class="font-weight-bold mb-2">사용자 이름자리</span> <span
								class="text-secondary text-small">사용자 직함자리</span>
						</div> <i class="mdi mdi-bookmark-check text-success nav-profile-badge"></i>
				</a></li>
				<li class="nav-item"><a class="nav-link" href="index.html">
						<span class="menu-title">메인화면</span> <i
						class="mdi mdi-home menu-icon"></i>
				</a></li>
				<li class="nav-item"><a class="nav-link"
					data-bs-toggle="collapse" href="#numberone" aria-expanded="false"
					aria-controls="ui-basic"> <span class="menu-title">진료</span> <i
						class="menu-arrow"></i> <i class="mdi mdi-stethoscope menu-icon"></i>
				</a>
					<div class="collapse" id="numberone">
						<ul class="nav flex-column sub-menu">
							...
							<li class="nav-item"><a class="nav-link" href="">수술실 예약</a></li>
							<li class="nav-item"><a class="nav-link" href="">수술실 예약
									조회</a></li>
							<li class="nav-item"><a class="nav-link" href="">입원실 예약</a></li>
							<li class="nav-item"><a class="nav-link" href="">입원실 예약
									조회</a></li>
						</ul>
					</div></li>
				<li class="nav-item"><a class="nav-link"
					data-bs-toggle="collapse" href="#numbertwo" aria-expanded="false"
					aria-controls="ui-basic"> <span class="menu-title">캘린더</span> <i
						class="menu-arrow"></i> <i
						class="mdi mdi-calendar-clock menu-icon"></i>
				</a>
				...
				<li class="nav-item"><a class="nav-link"
					data-bs-toggle="collapse" href="#number3" aria-expanded="false"
					aria-controls="ui-basic"> <span class="menu-title">원무</span> <i
						class="menu-arrow"></i> <i class="mdi mdi-cart-plus menu-icon"></i>
				</a>
				...
				<li class="nav-item"><a class="nav-link"
					data-bs-toggle="collapse" href="#number4" aria-expanded="false"
					aria-controls="ui-basic"> <span class="menu-title">메일</span> <i
						class="menu-arrow"></i> <i class="mdi mdi-email-outline menu-icon"></i>
						<!--아이콘 바꿔줘야함-->
				</a>
				...
				<li class="nav-item"><a class="nav-link" href="#number6"> <span
						class="menu-title">공지사항</span> <i
						class="mdi mdi-hospital menu-icon"></i>
				</a>
				...
				<li class="nav-item"><a class="nav-link" href="#number5"> <span
						class="menu-title">조직도</span> <i
						class="mdi mdi-clipboard-account menu-icon"></i>
				</a>
				...
				<li class="nav-item"><a class="nav-link"
					...
					aria-expanded="false" aria-controls="general-pages"> <span
						class="menu-title">페이지 예시</span> <i class="menu-arrow"></i> <i
