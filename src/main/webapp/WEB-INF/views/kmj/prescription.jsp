		...
		<div class="main-panel">
          <div class="content-wrapper"><!-- 이 안에서 작업해 주세요 -->
			<div class="wrap11">
              <br><br>
              <div >
                <div id="printArea" style="border: 1px solid black; width: 70%; margin: auto;">
                  <table class="table-bordered" border="1" style="font-size:0.7em; margin: auto; width: 100%; border-collapse: collapse;">
                    <tr>
