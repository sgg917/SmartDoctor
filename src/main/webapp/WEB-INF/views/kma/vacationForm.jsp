		...
		<div class="content-wrapper">
			...
			<div class="card">
				<div class="card-body">
					...
					<hr>
					<br>
					<form id="insertVacation" action="insertVacation.si" method="post">
						...
						<div class="appr-table-wrapper" style="margin-left:20px;">
                            ...
                            <tr>
                              <th>신청자</th>
                              <td colspan="3">${ loginUser.empName }</td>
                            </tr>
                            <tr>
                              <th>소속부서</th>
                              <td colspan="3">${ loginUser.deptName }</td>
                            </tr>
                            <tr>
                              <th>종류</th>
                              <td colspan="3">연차</td>
                            ...
                            <tr>
                              <th>일수</th>
                              <td colspan="3"><input type="number" value="1" name="vacDays"></td>
                            </tr>
                            <tr>
                              <th>사유</th>
                              <td colspan="3"><input type="text" name="vacCause" placeholder="사유를 입력해주세요" style="width:800px;"></td>
                            </tr>
                        </table>
						</div>
					</form>
